...
wget_command="wget -O /tmp/netdata-kickstart.sh https://get.netdata.cloud/kickstart.sh && sh /tmp/netdata-kickstart.sh --${version} --claim-token ${claim_token} --claim-rooms ${claim_rooms} --claim-url https://app.netdata.cloud"
